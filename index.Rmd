...
![A tentative visualization of the snakemake workflow that defines **metadata acquisition rules** in a DAG (directed acyclic graph) format.](dags/rulegraph.svg). 
A detailed interactive snakemake report is available [here](file:///Users/tmbuza/Dropbox/MICROBIOME/imap-sample-metadata/report.html).
...
> We can use a styleshee like so: `snakemake --report report.html --report-stylesheet smk.css`.

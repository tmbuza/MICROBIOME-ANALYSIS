...
date:
- IMAP-PART 01<br>[Latest GitHub-Repo](https://github.com/tmbuza/imap-sample-metadata/)<br>
...
github_repo: "https://github.com/tmbuza/imap-sample-metadata"
description: |
...
colnames(PRJNA477349) %>% as.data.frame %>% head(5)
colnames(PRJNA477349) %>% as.data.frame %>% tail(5)
paste("There are", dim(PRJNA477349)[1], "rows and", dim(PRJNA477349)[2],"columns in PRJNA477349 metadata")

PRJNA802976 <- read_csv("data/metadata/PRJNA802976_metadata.csv", show_col_types = FALSE)
colnames(PRJNA802976) %>% as.data.frame %>% head(5)
colnames(PRJNA802976) %>% as.data.frame %>% tail(5)
paste("There are", dim(PRJNA802976)[1], "rows and", dim(PRJNA802976)[2],"columns in PRJNA802976 metadata")

PRJNA685168 <- read_csv("data/metadata/PRJNA685168_metadata.csv", show_col_types = FALSE)
colnames(PRJNA685168) %>% as.data.frame %>% head(5)
colnames(PRJNA685168) %>% as.data.frame %>% tail(5)
paste("There are", dim(PRJNA685168)[1], "rows and", dim(PRJNA685168)[2],"columns in PRJNA685168 metadata")

PRJEB21612 <- read_csv("data/metadata/PRJEB21612_metadata.csv", show_col_types = FALSE)
colnames(PRJEB21612) %>% as.data.frame %>% head(5)
colnames(PRJEB21612) %>% as.data.frame %>% tail(5)
paste("There are", dim(PRJEB21612)[1], "rows and", dim(PRJEB21612)[2],"columns in PRJEB21612 metadata")
```

---
title:  "<big><u>IMAP-PART 02</u></big><br><br>Downloading and exploring microbiome sample metadata from SRA Database<br><br>"
subtitle: |
  | ![](images/geeks.png)<br>
  | Fostering Reproducible Microbiome data Analysis with Snakemake workflow
date:
- IMAP-PART 02<br>[Latest GitHub-Repo](https://github.com/tmbuza/imap-sample-metadata/)<br>
...
```{r child='workflow/scripts/01_download_sra_metadata.Rmd'}
```

<br>

```{r child='workflow/scripts/02_explore_sra_metadata.Rmd'}
```
...
## Screenshot of interactive snakemake report {#smkstats}
> The interactive snakemake HTML report can be viewed by opening the `report.html` using any compatible browser. You will be able to explore the workflow and the associated statistics [#smk-statistics]. You can close the left bar to get a more expansive display view.
...
## Snakemake statistics [#smkstats]
![Rule creation time](images/analysis_statistics.svg)

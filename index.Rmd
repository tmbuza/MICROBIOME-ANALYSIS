...
A tentative snakemake workflow that defines **rules for downloading and expoloring sample metadata** in a DAG (directed acyclic graph) format. 
A detailed interactive snakemake report is available [here](https://complexdatainsights.com/imap/imap-sample-metadata/report.html). Use a wider screen to get a better interactive snakemake report.

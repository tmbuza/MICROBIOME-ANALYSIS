...
5. [PRJNA589182](https://www.ncbi.nlm.nih.gov/sra/?term=PRJNA589182): 16S rDNA gene sequencing of the phyllosphere endophytic bacterial communities colonizing wild (Multispecies).
...
- We can download SRA metadata using python via the SRAweb like so:
...
Next, we will explore downloaded metadata to learn more about the various features represented.
...
PRJNA477349 <- read_csv("data/metadata/PRJNA477349_metadata.csv", show_col_types = FALSE)

PRJNA685168 <- read_csv("data/metadata/PRJNA685168_metadata.csv", show_col_types = FALSE)

PRJEB21612 <- read_csv("data/metadata/PRJEB21612_metadata.csv", show_col_types = FALSE)

PRJNA802976 <- read_csv("data/metadata/PRJNA802976_metadata.csv", show_col_types = FALSE)

...
metadata <- read_csv("results/sample_location.csv", show_col_types = FALSE)
...
## save html to png
saveWidget(m, "images/gpsfiles/sample_gps.html", selfcontained = FALSE)
webshot("images/gpsfiles/sample_gps.html", file = "images/sample_gps.png",
        cliprect = "viewport")